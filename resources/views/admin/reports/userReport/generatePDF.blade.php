    ...
    <section class="content">
        <div class="card">
            <div class="text-center pt-3 top-part" style="margin-top: 2rem;">
                ...
                <p class="table-ordreport mb-0 pt-2 space-rem">USER LIST REPORT</p>
                ...
                <p class="table-ordreport mb-0 pt-2">User Name: {{ucwords(@$_GET['user_name'])}}</p>
                @endif
                ...
                <p class="table-ordreport mb-0 pt-2">User Status: {{ucwords(@$_GET['user_status'])}}</p>
                @endif
                    ...
                    <table id="dataList1" class="table table-bordered table-striped" style="width: 100%;">
                        <thead>
                            <tr role="row" style="background-color: #256BB7; border: 1px solid #dee2e6; color: #fff; font-weight: 600;">
                                ...
                                <th class="table-head-notify" tabindex="0" aria-controls="example2" rowspan="1" colspan="1">Full Name</th>
                                ...
                                <th class="table-head-notify" tabindex="0" aria-controls="example2" rowspan="1" colspan="1">Role</th>
                                <th class="table-head-notify" tabindex="0" aria-controls="example2" rowspan="1" colspan="1">Status</th>

                            </tr>
                        </thead>
                        <tbody <?php $i = 0; ?> @foreach($userData AS $key=>$data)
                            ...
                            <tr class="table-data-con">
                                ...
                                <td class="text-center">{{$data['getRole']['name']??''}} <br>
                                </td>
                                <td class="text-center">{{ucwords($data->user_status_text)}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
