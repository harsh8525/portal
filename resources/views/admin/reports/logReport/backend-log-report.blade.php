    ...
    <div class="row mb-4 mt-2">
      <div class="col-sm-12 align-items-center d-flex breadcrumb-style">
        ...
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Backend Log Report</li>
        </ol>
      ...
      <div class="card pb-3 pt-3 px-3 w-100">
        <div class="discount">
          ...
          <div class="grid-list-head py-2">
            <h3 class="mt-2 mb-0">Backend Log Report
            </h3>
            <div class="gridlist-icons">

              <div class="export grid-icon-top" title="PDF">
                <a href="{{ route('admin.backend-log-report.pdf',['logData' => $logData,  'fromDate'=>$fromDate, 'toDate'=> $toDate]) }}" target="_blank" class="btn btn-success float-right plush-icon"><i class="far fa-file-pdf"></i></a>
                </a>
              </div>
              <div class="export grid-icon-top" title="Export">
                <a href="{{ route('admin.backend-log-report.export',['logData' => $logData,  'fromDate'=>$fromDate, 'toDate'=> $toDate]) }}" class="btn btn-success float-right plush-icon"><i class="fas fa-file-export"></i></a>
                </a>
              </div>
            ...
            <div class="filter-collapse w-100" id="collapseExample">
              <form autocomplete="off" id="filter" method="GET" action="{{route('reports.backendlogReport.log-report')}}">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 filter-buttons">
                      ...
                      <div class="filter-btm-btn" title="Refresh">
                        <a href="{{route('reports.backendlogReport.log-report')}}" class="refress-filter">
              ...
              <div class="table-card">
                ...
                <div class="card-body table-radius table-responsive p-0">
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody class="td-data-color vertical-scroll-effect">
                      <?php
                      ...
                      <tr>
                        ...
                        <td>
                          <?php
                          $userName = App\Models\User::where('id',$data['user_id'])->value('name');
                          ?>
                        <a target="_blank" href="{{ route('user.show',$data['user_id']) }}" title="View">{{ $userName }}</a>
                        ...
                        <td style="width: 80%; text-transform: none !important;">
                          <p>
                          {{$data['request']??''}}
                          </p>
                        </td>
                ...
                <nav class="pagination-grid" aria-label="Page  navigation example">
                  <ul class="pagination">
                    <?php if ($logData->hasPages()) { ?>
                      {!! $logData->appends(Request::except('page'))->render() !!}
                    <?php } ?>
                  </ul>
                </nav>
                @endif
