    ...
    <div class="row mb-4 mt-2">
      <div class="col-sm-12 align-items-center d-flex breadcrumb-style">
        ...
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Monthly Customer Report</li>
        </ol>
      ...
      <div class="card pb-3 pt-3 px-3 w-100">
        <div class="discount">
          ...
          <div class="grid-list-head py-2">
            <h3 class="mt-2 mb-0">Monthly list customer Report
            </h3>
            <div class="gridlist-icons">

              <div class="export grid-icon-top" title="PDF">
                <a href="{{ route('admin.master-monthly-customer-report.pdf',['customerData' => $customerData,  'fromDate'=>$fromDate, 'toDate'=> $toDate]) }}" target="_blank" class="btn btn-success float-right plush-icon"><i class="far fa-file-pdf"></i></a>
                </a>
              </div>
              <div class="export grid-icon-top" title="Export">
                <a href="{{ route('admin.master-monthly-customer-report.export',['customerData' => $customerData,  'fromDate'=>$fromDate, 'toDate'=> $toDate]) }}" class="btn btn-success float-right plush-icon"><i class="fas fa-file-export"></i></a>
                </a>
              </div>
            ...
            <div class="filter-collapse w-100" id="collapseExample">
              <form autocomplete="off" id="filter" method="GET" action="{{route('reports.monthlyCustomerReport.monthly-customer-report')}}">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 filter-buttons">
                      ...
                      <div class="filter-btm-btn" title="Refresh">
                        <a href="{{route('reports.monthlyCustomerReport.monthly-customer-report')}}" class="refress-filter">
          ...
          <div class="report_logo_cont" style="text-align: center">
            <div>
              ...
              <div class="" style="color:black;">
                <span>MONTHLY LIST CUSTOMER REPORT</span>
                <span>
