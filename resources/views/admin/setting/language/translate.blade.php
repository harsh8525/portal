        ...
        <div class="row mb-4 mt-2">
            <div class="col-sm-12 align-items-center d-flex breadcrumb-style">
                ...
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">B2C Translate</li>
                </ol>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="card pb-3 pt-3 px-3 w-100">
                <div class="discount">
                    ...
                    <div class="grid-list-head py-2">
                        ...
                        <div class="collapse filter-collapse w-100" id="collapseExample">
                            <form autocomplete="off" id="filter" method="GET" action="{{ route('language.translate.b2c',$id) }}">
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="col-md-3 filter-form mb-3">
                                                    <div class="form-floating">
                                                        <div class="form-item form-float-style">
                                                            ...
                                                            <label for="sort">Search By Value English</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-3 filter-form mb-3">
                                                    <div class="form-floating">
                                                        <div class="form-item form-float-style">
                                                            <input type="text" id="search_value_arabic" name="search_value_arabic" autocomplete="off" value="{{@$_GET['search_value_arabic']}}" class="is-valid">
                                                            <label for="sort">Search By Value Arabic</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-2 filter-buttons">
                                            ...
                                            <div class="refress-filter filter-btm-btn" title="Refresh">
                                                <a href="{{route('language.translate.b2c',$id)}}">
                ...
                <form id="dataForm" name="dataForm" class="form row mb-0 pt-3 validate" action="{{ route('languages.updateLangTranslator') }}" enctype="multipart/form-data" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-md-12 row"><!-- Start col-md-12 row  Div -->
                        ...
                        <table class="table table-head-fixed" id="addMore">
                            ...
                            <tbody class="td-data-color">
                                ...
                                @foreach($content['english'] as $data =>$values)
                                <tr>
                                    <td><?= ++$i ?></td>
                                    <td style="width: 50%;">
                                    ...
                                    <td>
                                        <textarea name="value_english[]" type="text" id="language_code" autocomplete="off">{{ $values ?? '' }}</textarea>
                                    </td>
                                    <td>
                                        <textarea name="value_arabic[]" type="text" id="language_code" autocomplete="off" dir="rtl">{{ $content['arabic'][$data] ?? '' }}</textarea>
                                    </td>
                                </tr>
                                @endforeach
                                @else
...
<script>
    ...
    function addMore() {
        ...
        if (isValid && match) {
            ...
            inputElement_cell4.name = "value_english[]"; // Set the input name
            inputElement_cell4.autocomplete = "off"; // Set the input autocomplete
            inputElement_cell4.id = "add_more_value"; // Set the input id
            inputElement_cell4.placeholder = "value english"; // Set the input placeholder

            var inputElement_cell8 = document.createElement("input");
            inputElement_cell8.type = "text"; // Set the input type
            inputElement_cell8.name = "value_arabic[]"; // Set the input name
            inputElement_cell8.autocomplete = "off"; // Set the input autocomplete
            inputElement_cell8.id = "add_more_value"; // Set the input id
            inputElement_cell8.placeholder = "value arabic"; // Set the input placeholder
            ...
            cell4.appendChild(inputElement_cell8);
            counter++;
        }
    };
