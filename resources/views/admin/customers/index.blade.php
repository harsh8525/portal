            ...
            <div class="col-sm-12 d-flex breadcrumb-style">
              ...
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">@lang('customers.dashboard') </a></li>
                  <li class="breadcrumb-item active"><a href="{{ route('customers.index') }}">@lang('customers.moduleHeading')</a></li>
              </ol>
              <div class="breadcrumb-btn">
                <div class="add-breadcrumb">
                  <a href="{{ route('customers.create') }}" title="Add">
                ...
                <div class="delete-breadcrumb">
                  <a data-url="{{route('admin.customers.delete',['customer_id'=>''])}}" title="Delete" class="deleteAllConfirmation btn-hover-del">
                ...
                <div class="grid-list-head py-2">
                  ...
                  <div class="gridlist-icons">
                    <?php if(isset($_GET['per_page'])  && $_GET['per_page'] !== ""){
                      ?>
                    <div>
                      <h6>Showing {{ $customerData->firstItem() ? $customerData->firstItem() :'0' }} to {{ $customerData->lastItem() ? $customerData->lastItem() :'0' }}
                          of total {!! $customerData->total() !!} entries (filtered from {{ $customerDataCount }} total entries) </h6>
                    </div>
                    <?php } else {?> 
                    <div>
                       <h6>Showing {{ $customerData->firstItem() ? $customerData->firstItem() :'0' }} to {{ $customerData->lastItem() ? $customerData->lastItem() :'0' }}
                          of total {!! $customerData->total() !!} entries</h6>
                    </div>
                    <?php } ?>
                 ...
                 <div class="collapse filter-collapse w-100" id="collapseExample">
                     <form autocomplete="off" id="filter" method="GET" action="{{route('customers.index')}}">
                                      ...
                                      <div class="col-md-3 filter-form mb-3">
                                             <div class="form-floating">
                                                 <div class="form-item form-float-style">
                                                     <input type="text" id="first_name" class="is-valid" name="full_name" autocomplete="off" value="{{@$_GET['full_name']}}">
                                           ...
                                           <div class="col-md-3 filter-form mb-3">
                                             <div class="form-floating">
                                                 <div class="form-item form-float-style">
                                                     <input type="text" id="email" class="is-valid" name="email" autocomplete="off" value="{{@$_GET['email']}}">
                                                     <label for="email">@lang('customers.emailAddress')</label>
                                                 </div>
                                             </div>
                                         </div>
                                         <div class="col-md-3 filter-form mb-3">
                        ...
                        <table class="table table-head-fixed text-nowrap">
                          <thead class="td-data-color">
                            <tr>
                              ...
                              <th>Full Name <a href="{{Request::url().$queryStringConcat}}&order_by=first_name&sorting={{($appliedFilter['sorting']=='desc') ? 'asc' : 'desc'}}"><svg width="12" height="12" fill="#ffffff"
                                  ...
                                  <th>@lang('customers.emailAddress')<a href="{{Request::url().$queryStringConcat}}&order_by=email&sorting={{($appliedFilter['sorting']=='desc') ? 'asc' : 'desc'}}"><svg width="12" height="12" fill="#ffffff"
                                    shape-rendering="geometricPrecision" text-rendering="geometricPrecision"
                                    image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd"
                                    viewBox="0 0 322 511.21">
                                    <path fill-rule="nonzero"
                               ...
                               <th>@lang('customers.mobileNumber') <a href="{{Request::url().$queryStringConcat}}&order_by=mobile&sorting={{($appliedFilter['sorting']=='desc') ? 'asc' : 'desc'}}"><svg width="12" height="12" fill="#ffffff"
                                    shape-rendering="geometricPrecision" text-rendering="geometricPrecision"
                                    image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd"
                                    viewBox="0 0 322 511.21">
                                    <path fill-rule="nonzero"
                                ...
                                <th>@lang('customers.status')<a href="{{Request::url().$queryStringConcat}}&order_by=status&sorting={{($appliedFilter['sorting']=='desc') ? 'asc' : 'desc'}}"><svg width="12" height="12" fill="#ffffff"
                                    shape-rendering="geometricPrecision" text-rendering="geometricPrecision"
                                    image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd"
                                    viewBox="0 0 322 511.21">
                                    <path fill-rule="nonzero"
                          ...
                          <tbody class="td-data-color">
                           ...
                           ?>
                            <tr class="{{$className}}">
                              <th class="list-checkbox">
                                <input class="@if($data['status'] == 'deleted') d-none @endif" class="form-check-input" name="check" type="checkbox" value="{{$data['id']}}"
                                  id="flexCheckDefault">
                              ...
                              <td>
                                <a href="{{ route('customers.show',$data['id']) }}" title="View">{{$data['first_name']}} {{$data['last_name']}}</a>
                              </td>
                           ...
                           <td>
                              ...
                              <td class="table-action">
                                  <a href="{{ route('customers.show',$data['id']) }}" title="View">
                                  ...
                                  <span>
                                  <a data-url="{{route('admin.customers.delete',['customer_id'=>$data['id']])}}" type="button" title="Delete"
