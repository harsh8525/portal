        ...
        <div class="container-fluid">
          <div class="row mb-4 mt-2">
            <div class="col-sm-12 d-flex breadcrumb-style">
              <h1 class="m-0">Agency Type - Edit</h1>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="card pb-4 pt-3 px-3 w-100">
              <form id="dataForm" action="{{route('agency-type.update',$agencyTypeDetail['id'])}}" class="form row pt-3 mb-0 validate" enctype="multipart/form-data" method="post">
                @csrf
                @method('PUT')
                <input type="hidden" name="redirects_to" id="redirects_to" value="{{ URL::previous() }}">
                <input type="hidden" value="{{ $agencyTypeDetail['id'] }}" name="agency_type_id" id="agency_type_id">
                <div class="col-md-12 row">
                  <div class="col-md-6">
                    <div class="form-item form-float-style">
                      <input name="agency_name" type="text" id="agency_name" autocomplete="off" required value="{{ $agencyTypeDetail['name'] }}" class="is-valid">
                ...
                <div class="col-md-12 row">
                  <div class="col-md-6">
                    <div class="form-item form-float-style">
                        <textarea name="agency_description" class="is-valids">{{ $agencyTypeDetail['description'] }}</textarea>
                    ...
                    <div class="form-floating form-item mb-0">
                        <div class="form-item form-float-style serach-rem mb-0">
                            ...
                            <select data-live-search="true" id="status" name="status" class="order-td-input selectpicker select-text height_drp is-valid">
                                <option value="1" @if($agencyTypeDetail['is_active'] == '1') selected="selected" @endif>Active</option>
                                <option value="0" @if($agencyTypeDetail['is_active'] == '0') selected="selected" @endif>In-active</option>
                            </select>
