            ...
            <div class="col-sm-12 align-items-center d-flex breadcrumb-style">
              ...
              <div class="breadcrumb-btn">
                ...
                <div class="delete-breadcrumb">
                  <a data-url="{{route('agency-type.delete',['agency_id'=>''])}}" data-bs-toggle="modal" data-bs-target="#exampleModal" title="Delete"
            ...
            <div class="card pb-3 pt-3 px-3 w-100">
              <div class="discount">
                ...
                <div class="grid-list-head py-2">
                  <h3>Agency Type List</h3>
                  <div class="gridlist-icons">
                    <?php if(isset($_GET['per_page'])  && $_GET['per_page'] !== ""){
                      ?>
                    <div>
                      <h6>Showing {{ $agencyTypeData->firstItem() ? $agencyTypeData->firstItem() :'0' }} to {{ $agencyTypeData->lastItem() ? $agencyTypeData->lastItem() :'0' }}
                          of total {!! $agencyTypeData->total() !!} entries (filtered from {{ $agencyTypeDataCount }} total entries) </h6>
                    </div>
                    <?php } else {?> 
                    <div>
                       <h6>Showing {{ $agencyTypeData->firstItem() ? $agencyTypeData->firstItem() :'0' }} to {{ $agencyTypeData->lastItem() ? $agencyTypeData->lastItem() :'0' }}
                          of total {!! $agencyTypeData->total() !!} entries</h6>
                    </div>
                    <?php } ?>
                  ...
                  <form autocomplete="off" id="filter" method="GET" action="{{route('agency-type.index')}}">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-2 filter-buttons">
                          <button type="submit" class="submit-filter filter-btm-btn" title="Apply">
                              <a href="{{route('agency-type.index')}}">
                  ...
                  <div class="col-12">
                    <div class="table-card">
                      ...
                      <div class="card-body table-radius table-responsive p-0">
                        <table class="table table-head-fixed text-nowrap">
                          ...
                          <tbody class="td-data-color">
                           @forelse($agencyTypeData as $key=>$data)
                           <?php 
                           $className = "";
                           if($data->is_active == 2 ){
                           ...
                           ?>
                            <tr class="{{$className}}">
                              ...
                              <a href="{{ route('agency-type.show',$data['id']) }}" title="View">{{$data['name']}}</a>
                              </td>
                              <td>
                              ...
                              <span>  
                                  <a href="{{ route('agency-type.show',$data['id']) }}" title="View">
                                ...
                                <span class="@if($data['is_active'] == 2) d-none @endif">
                                  <a href="{{ route('agency-type.edit',$data['id']) }}" title="Edit">
                                    <?xml version="1.0"?><svg fill="#198754" viewBox="0 0 24 24" width="20" height="20">
                                      <path
                                        d="M 19.171875 2 C 18.448125 2 17.724375 2.275625 17.171875 2.828125 L 16 4 L 20 8 L 21.171875 6.828125 C 22.275875 5.724125 22.275875 3.933125 21.171875 2.828125 C 20.619375 2.275625 19.895625 2 19.171875 2 z M 14.5 5.5 L 3 17 L 3 21 L 7 21 L 18.5 9.5 L 14.5 5.5 z" />
                                    </svg></a></span>
                                <span>
                                  <a data-url="{{route('agency-type.delete',['agency_id'=>$data['id']])}}" data-bs-toggle="modal" data-bs-target="#exampleModal" type="button" title="Delete"
                      ...
                      <nav class="pagination-grid" aria-label="Page  navigation example">
                        <ul class="pagination">
                            <?php if($agencyTypeData->hasPages()) { ?>
                          {!!$agencyTypeData->appends(Request::except('page'))->render() !!}
                            <?php } ?>
                        </ul>
                      </nav>
                      <!-- /.card-body -->
