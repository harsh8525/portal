            ...
            <div class="col-sm-12 align-items-center d-flex breadcrumb-style">
              ...
              <div class="breadcrumb-btn">
                <div class="add-breadcrumb">
                  <a href="{{ route('banks.create') }}" title="Add">
                ...
                <div class="delete-breadcrumb">
                  <a data-url="{{route('bank.delete',['bank_type_id'=>''])}}" data-bs-toggle="modal" data-bs-target="#exampleModal" title="Delete"
                ...
                <div class="grid-list-head py-2">
                  ...
                  <div class="gridlist-icons">
                    <?php if(isset($_GET['per_page'])  && $_GET['per_page'] !== ""){
                      ?>
                    <div>
                      <h6>Showing {{ $bankTypeData->firstItem() ? $bankTypeData->firstItem() :'0' }} to {{ $bankTypeData->lastItem() ? $bankTypeData->lastItem() :'0' }}
                          of total {!! $bankTypeData->total() !!} entries (filtered from {{ $bankCountData }} total entries) </h6>
                    </div>
                    <?php } else {?> 
                    <div>
                       <h6>Showing {{ $bankTypeData->firstItem() ? $bankTypeData->firstItem() :'0' }} to {{ $bankTypeData->lastItem() ? $bankTypeData->lastItem() :'0' }}
                          of total {!! $bankTypeData->total() !!} entries</h6>
                    </div>
                    <?php } ?>
                        ...
                        <div class="col-md-10">
                          <div class="row">
                            <div class="col-md-3 filter-form mb-3">
                              <div class="form-floating">
                                <div class="form-item form-float-style">
                                  <input type="text" id="bank_code" name="bank_code" autocomplete="off" value="{{@$_GET['bank_code']}}" class="is-valid">
                                  <label for="sort">Bank Code</label>
                                </div>
                              </div>
                            </div>
                            <div class="col-md-3 filter-form mb-3">
                              <div class="form-floating">
                                <div class="form-item form-float-style">
                                  <input type="text" id="bank_name" name="bank_name" autocomplete="off" value="{{@$_GET['bank_name']}}" class="is-valid">
                            ...
                            <div class="col-md-3 filter-form mb-3">
                              <div class="form-floating">
                                <div class="form-item form-float-style">
                                  <input type="text" id="account_number" name="account_number" autocomplete="off" value="{{@$_GET['account_number']}}" class="is-valid">
                                  <label for="sort">Account Number</label>
                                </div>
                              </div>
                            </div>
                    ...
                    <div class="table-card">
                      ...
                      <div class="card-body table-radius table-responsive p-0">
                        <table class="table table-head-fixed text-nowrap">
                          <thead class="td-data-color">
                            <tr>
                              ...
                              <th> <span>Sr. No. </span></th>
                               <th>Bank Code  <a href="{{Request::url().$queryStringConcat}}&order_by=bank_code&sorting={{($appliedFilter['sorting']=='desc') ? 'asc' : 'desc'}}"><svg width="12" height="12" fill="#ffffff"
                              ...
                              <th>Bank Name <a href="{{Request::url().$queryStringConcat}}&order_by=bank_name&sorting={{($appliedFilter['sorting']=='desc') ? 'asc' : 'desc'}}"><svg width="12" height="12" fill="#ffffff"
                                    shape-rendering="geometricPrecision" text-rendering="geometricPrecision"
                                    image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd"
                                    viewBox="0 0 322 511.21">
                                    <path fill-rule="nonzero"
                              ...
                              <th>Account Number <a href="{{Request::url().$queryStringConcat}}&order_by=account_number&sorting={{($appliedFilter['sorting']=='desc') ? 'asc' : 'desc'}}"><svg width="12" height="12" fill="#ffffff"
                                    shape-rendering="geometricPrecision" text-rendering="geometricPrecision"
                                    image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd"
                                    viewBox="0 0 322 511.21">
                                    <path fill-rule="nonzero"
                          ...
                          @forelse($bankTypeData as $key=>$data)
                            <tr>
                              <th class="list-checkbox">
                              ...
                              <a href="{{ route('banks.show',$data['id']) }}" title="View">{{$data['bank_name']}}</a>
                              </td>
                              <td>
                                {{ $data['account_number'] }}
                              </td>
                              ...
                              <span>  
                                  <a href="{{ route('banks.show',$data['id']) }}" title="View">
                                ...
                                <span>
                                  <a href="{{ route('banks.edit',$data['id']) }}" title="Edit">
                                    <?xml version="1.0"?><svg fill="#198754" viewBox="0 0 24 24" width="20" height="20">
                                      <path
                                        d="M 19.171875 2 C 18.448125 2 17.724375 2.275625 17.171875 2.828125 L 16 4 L 20 8 L 21.171875 6.828125 C 22.275875 5.724125 22.275875 3.933125 21.171875 2.828125 C 20.619375 2.275625 19.895625 2 19.171875 2 z M 14.5 5.5 L 3 17 L 3 21 L 7 21 L 18.5 9.5 L 14.5 5.5 z" />
                                    </svg></a></span>
                                <span>
                                  <a data-url="{{route('bank.delete',['bank_type_id'=>$data['id']])}}" data-bs-toggle="modal" data-bs-target="#exampleModal" type="button" title="Delete"
                      ...
                      <nav class="pagination-grid" aria-label="Page  navigation example">
                        <ul class="pagination">
                            <?php if($bankTypeData->hasPages()) { ?>
                          {!!$bankTypeData->appends(Request::except('page'))->render() !!}
                            <?php } ?>
                        </ul>
                      </nav>
                      <!-- /.card-body -->
