            ...
            <div class="col-sm-12 align-items-center d-flex breadcrumb-style">
              ...
              <div class="breadcrumb-btn">
                <div class="add-breadcrumb">
                  <a href="{{ route('paymentmethod.create') }}" title="Add">
                ...
                <div class="delete-breadcrumb">
                  <a data-url="{{route('paymentmethod.delete',['payment_type_id'=>''])}}" data-bs-toggle="modal" data-bs-target="#exampleModal" title="Delete"
            ...
            <div class="card pb-3 pt-3 px-3 w-100">
              <div class="discount">
                ...
                <div class="grid-list-head py-2">
                  ...
                  <div class="gridlist-icons">
                    ...
                    <div>
                      <h6>Showing {{ $paymentData->firstItem() ? $paymentData->firstItem() :'0' }} to {{ $paymentData->lastItem() ? $paymentData->lastItem() :'0' }}
                          of total {!! $paymentData->total() !!} entries (filtered from {{ $paymentDataCount }} total entries) </h6>
                    </div>
                    <?php } else {?> 
                    <div>
                       <h6>Showing {{ $paymentData->firstItem() ? $paymentData->firstItem() :'0' }} to {{ $paymentData->lastItem() ? $paymentData->lastItem() :'0' }}
                  ...
                  <form autocomplete="off" id="filter" method="GET" action="{{route('paymentmethod.index')}}">
                        ...
                        <table class="table table-head-fixed text-nowrap">
                          ...
                          @forelse($paymentData as $key=>$data)
                            ...
                            <tr class="{{$className}}">
                              ...
                              <a href="{{ route('paymentmethod.show',$data['id']) }}" title="View">{{$data['name']}}</a>
                              </td>
                              <td>
                                {{ $data['description'] }}
                              </td>
                              ...
                              <span>  
                                  <a href="{{ route('paymentmethod.show',$data['id']) }}" title="View">
                                ...
                                <span class="@if($data['is_active'] == 2) d-none @endif">
                                  <a href="{{ route('paymentmethod.edit',$data['id']) }}" title="Edit">
                                    <?xml version="1.0"?><svg fill="#198754" viewBox="0 0 24 24" width="20" height="20">
                                      <path
                                        d="M 19.171875 2 C 18.448125 2 17.724375 2.275625 17.171875 2.828125 L 16 4 L 20 8 L 21.171875 6.828125 C 22.275875 5.724125 22.275875 3.933125 21.171875 2.828125 C 20.619375 2.275625 19.895625 2 19.171875 2 z M 14.5 5.5 L 3 17 L 3 21 L 7 21 L 18.5 9.5 L 14.5 5.5 z" />
                                    </svg></a></span>
                                <span>
                                  <a data-url="{{route('paymentmethod.delete',['payment_type_id'=>$data['id']])}}" data-bs-toggle="modal" data-bs-target="#exampleModal" type="button" title="Delete"
