    ...
    <div class="container-fluid">
        <div class="row mb-4 mt-2">
            <div class="col-sm-12 d-flex breadcrumb-style">
                <h1 class="m-0">Default {{$serviceType}} Markup - Edit</h1>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="card pb-4 pt-3 px-3 w-100">
                <form id="dataForm" name="dataForm" class="form row mb-0 pt-3 validate" action="{{ route('update-default-markups',$markupsDetail['id']) }}" enctype="multipart/form-data" method="post">
                    @csrf
                    <input type="hidden" name="default_markups_id" id="markups_id" value="{{$markupsDetail['id']}}" />
                    ...
                    <div class="col-md-6">
                        <div class="col-md-12">
                            <div class="form-floating form-item mb-0">
                                <div class="form-item form-float-style serach-rem mb-0" style="pointer-events: none;">
