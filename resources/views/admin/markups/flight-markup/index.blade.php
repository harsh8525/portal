        ...
        <div class="container-fluid">
          <div class="row mb-4 mt-2">
            <div class="col-sm-12 align-items-center d-flex breadcrumb-style">
              <h1 class="m-0">Flight Markup</h1>
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard')}}">@lang('adminUser.dashboard')</a></li>
                <li class="breadcrumb-item active">Flight Markup Rules List</li>
              </ol>
              <div class="breadcrumb-btn">
                <div class="add-breadcrumb">
                @foreach($markupsData as $key => $data)
                 <?php $default_markup_id = App\Models\DefaultMarkup::where('service_type_id',$data->getServiceType->id)->value('id'); 
                 ?>
                 @endforeach
                  @if($default_markup_id)
                  <a href="{{ route('default-flight-markups-edit.edit',$default_markup_id) }}?service_type={{$service_type['code']}}" title="Edit">
                    ...
                    @else
                    <a href="{{ route('markups.addDefaultMarkup',['service_type'=>$service_type['code']]) }}" title="Add">
                    <?xml version="1.0" encoding="utf-8"?><svg fill="#ffffff" height="15" width="15" version="1.1"
                      id="Layer_1" x="0px" y="0px" width="122.881px" height="122.88px" viewBox="0 0 122.881 122.88"
                      enable-background="new 0 0 122.881 122.88" xml:space="preserve">
                      <g>
                ...
                <div class="add-breadcrumb">
                  <a href="{{ route('flight-markups.create',['service_type'=>$service_type['code']]) }}" title="Add">
                    <?xml version="1.0" encoding="utf-8"?><svg fill="#ffffff" height="15" width="15" version="1.1"
                      id="Layer_1" x="0px" y="0px" width="122.881px" height="122.88px" viewBox="0 0 122.881 122.88"
                      enable-background="new 0 0 122.881 122.88" xml:space="preserve">
                      <g>
            ...
            <div class="card pb-3 pt-3 px-3 w-100">
              <div class="discount">
                ...
                <div class="grid-list-head py-2">
                  <h3>FLIGHT Markup Rules List</h3>
                  ...
                  <div class="collapse filter-collapse w-100" id="collapseExample">
                    <form autocomplete="off" id="filter" method="GET" action="{{route('flight-markups.index')}}">
                        ...
                        <div class="row">
                          <div class="col-md-10">
                            ...
                            <div class="col-md-3 filter-form mb-3">
                                ...
                                <div class="form-floating">
                                  <div class="select top-space-rem after-drp form-float-style">
                                    <select data-live-search="true" id="originCriteria" name="originCriteria" class="order-td-input selectpicker select-text height_drp is-valid" style="width: 100%;">
                                      <option value="">Select Origin Criteria</option>
                                            <option value="all" @if($appliedFilter['originCriteria'] == 'all') selected="selected" @endif>All</option>
                                            <option value="country" @if($appliedFilter['originCriteria'] == 'country') selected="selected" @endif>Country</option>
                                            <option value="city" @if($appliedFilter['originCriteria'] == 'city') selected="selected" @endif>City</option>
                                            <option value="airport" @if($appliedFilter['originCriteria'] == 'airport') selected="selected" @endif>Airport</option>
                                        </select>
                                    <label class="select-label searchable-drp" style="font-size: 12px; font-weight: 400 !important;">Select Origin Criteria</label>
                                 </div>
                              </div>
                            </div>
                              <div class="col-md-4 filter-form mb-3">
                                <div class="form-floating">
                                  ...
                                  <option value="">Select Destination Criteria</option>
                                            ...
                                            <option value="airport" @if($appliedFilter['destinationCriteria'] == 'airport') selected="selected" @endif>Airport</option>
                                        </select>
                              ...
                              <div class="col-md-4 filter-form mb-3">
                                <div class="form-floating">
                                  <div class="select top-space-rem after-drp form-float-style">
                                  <select data-live-search="true" style="width: 100%;" id="cabinClass" name="cabinClass" class="order-td-input selectpicker select-text height_drp is-valid">
                                            <option disabled selected>Select Cabin Class</option>
                                            <option value="first" @if($appliedFilter['cabinClass'] == 'first') selected="selected" @endif>First</option>
                                            <option value="business" @if($appliedFilter['cabinClass'] == 'business') selected="selected" @endif>Business</option>
                                            <option value="premium_economy" @if($appliedFilter['cabinClass'] == 'premium_economy') selected="selected" @endif>Premium Economy</option>
                                            <option value="economy" @if($appliedFilter['cabinClass'] == 'economy') selected="selected" @endif>Economy</option>
                                        </select>
                                    <label class="select-label searchable-drp" style="font-size: 12px; font-weight: 400 !important;">Select Cabin Class</label>
                                 </div>
                              </div>
                            </div>
                              <div class="col-md-4 filter-form mb-3">
                          ...
                          <div class="col-md-2 filter-buttons">
                            ...
                            <div class="refress-filter filter-btm-btn" title="Refresh">
                                <a href="{{route('flight-markups.index')}}">
                          ...
                          <tbody class="td-data-color">
                            @foreach($markupsData as $key => $data)
                                ...
                                <td class="no-data-list">
                                  ...
                                  <td>
                                    {{ $data->origin_criteria ?? '' }}
                                  </td>
                                  <td>
                                    
                                   
                                  @if($data->origin_criteria == 'country')
                                    @php
                                    $getCountry = \App\Models\Country::with('countryCode')->where('iso_code', $data->origin_name)->first();
                                    @endphp
                                        ...
                                        @if($getCountry)
                                            ...
                                            @endforeach
                                        @elseif($data->origin_name == 'all')
                                            {{ 'All' }}
                                        @else
                                            {{ '' }}
                                        @endif
                                    @elseif($data->origin_criteria == 'city')
                                        @php
                                            $getCity = \App\Models\City::with('cityCode')->where('iso_code', $data->origin_name)->first();
                                        @endphp
                                        @if($getCity)
                                        ...
                                        @else
                                            {{ '' }}
                                        @endif
                                    @elseif($data->origin_criteria == 'airport')
                                        @php
                                            $getAirport = \App\Models\Airport::with('airportName')->where('id', $data->origin_name)->first();
                                        @endphp
                                        @if($getAirport)
                                        ...
                                        @else
                                            {{ '' }}
                                        @endif
                                    @elseif($data->origin_criteria == 'all')
                                        {{ 'All' }}
                                    @endif
                                  ...
                                  @if($data['deleted_at'] == null)
                                   <span>
                                    <a href="{{ route('flight-markups.show',$data['id']) }}" title="View">
                                    ...
                                    <span>
                                      <a href="{{ route('flight-markups.edit',$data['id']) }}" title="Edit">
