        ...
        <div class="container-fluid">
          <div class="row mb-4 mt-2">
            <div class="col-sm-12 align-items-center d-flex breadcrumb-style">
              <h1 class="m-0">Featured Flights</h1>
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">@lang('adminUser.dashboard')</a></li>
                <li class="breadcrumb-item active">Featured Flights</li>
              </ol>
              <div class="breadcrumb-btn">
                <div class="add-breadcrumb">
                  <a href="{{ route('feature-flight.create') }}" title="Add">
                ...
                <div class="delete-breadcrumb">
                  <a data-url="{{route('feature-flight.delete',['feature_flight_id'=>''])}}" data-bs-toggle="modal" data-bs-target="#exampleModal" title="Delete"
                    class="deleteAllConfirmation btn-hover-del">
            ...
            <div class="card pb-3 pt-3 px-3 w-100">
              <div class="discount">
                ...
                <div class="grid-list-head py-2">
                  <h3>Featured Flights List</h3>
                  <div class="gridlist-icons">
                    
                    <?php if(isset($_GET['per_page'])  && $_GET['per_page'] !== ""){
                      ?>
                    <div>
                      <h6>Showing {{ $featureFlighTypeData->firstItem() ? $featureFlighTypeData->firstItem() :'0' }} to {{ $featureFlighTypeData->lastItem() ? $featureFlighTypeData->lastItem() :'0' }}
                          of total {!! $featureFlighTypeData->total() !!} entries (filtered from {{ $featureFlighTypeDataCount }} total entries) </h6>
                    </div>
                    <?php } else {?> 
                    <div>
                       <h6>Showing {{ $featureFlighTypeData->firstItem() ? $featureFlighTypeData->firstItem() :'0' }} to {{ $featureFlighTypeData->lastItem() ? $featureFlighTypeData->lastItem() :'0' }}
                          of total {!! $featureFlighTypeData->total() !!} entries</h6>
                    </div>
                    <?php } ?>
                  ...
                  <form autocomplete="off" id="filter" method="GET" action="">
                      ...
                      <div class="row">
                          ...
                          <div class="row">
                            <div class="col-md-3 filter-form mb-3">
                              <div class="form-floating">
                                ...
                                <select data-live-search="true" id="airline_code" name="airline_code" class="order-td-input selectpicker1 select-text height_drp is-valid select2"style="width: 100%;">
                                
                                </select>
                               <label class="select-label searchable-drp" style="font-size: 12px; font-weight: 400 !important;">Airline Name</label>
                                 </div>
                              </div>
                            </div>
                            <div class="col-md-3 filter-form mb-3">
                              <div class="form-floating">
                                <div class="select top-space-rem after-drp form-float-style">
                                <select data-live-search="true" id="from_airport_code" name="from_airport_code" class="order-td-input selectpicker1 select-text height_drp is-valid select2"style="width: 100%;">
                               
                                </select>
                               <label class="select-label searchable-drp" style="font-size: 12px; font-weight: 400 !important;">From Airport Name </label>
                                 </div>
                              </div>
                            </div>
                            ...
                            <div class="col-md-3 filter-form mb-3">
                              <div class="form-floating">
                                <div class="select top-space-rem after-drp form-float-style">
                                <select data-live-search="true" id="to_airport_code" name="to_airport_code" class="order-td-input selectpicker1 select-text height_drp is-valid select2"style="width: 100%;">
                                
                            </select>
                               <label class="select-label searchable-drp" style="font-size: 12px; font-weight: 400 !important;">To Airport Name</label>
                                 </div>
                              </div>
                            </div>
                        ...
                        <div class="col-md-2 filter-buttons">
                          ...
                          <div class="refress-filter filter-btm-btn" title="Refresh">
                              <a href="{{route('feature-flight.index')}}">
                  ...
                  <div class="col-12">
                    <div class="table-card">
                        ...
                        <table class="table table-head-fixed text-nowrap">
                          <thead class="td-data-color">
                            <tr>
                              ...
                              <th>Airline Name  <a href="{{Request::url().$queryStringConcat}}&order_by=airline_code&sorting={{($appliedFilter['sorting']=='desc') ? 'asc' : 'desc'}}"><svg width="12" height="12" fill="#ffffff"
                              ...
                              <th>From Airport <a href="{{Request::url().$queryStringConcat}}&order_by=from_airport_code&sorting={{($appliedFilter['sorting']=='desc') ? 'asc' : 'desc'}}"><svg width="12" height="12" fill="#ffffff"
                                    shape-rendering="geometricPrecision" text-rendering="geometricPrecision"
                                    image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd"
                                    viewBox="0 0 322 511.21">
                                    <path fill-rule="nonzero"
                                  ...
                                  <th>To Airport <a href="{{Request::url().$queryStringConcat}}&order_by=to_airport_code&sorting={{($appliedFilter['sorting']=='desc') ? 'asc' : 'desc'}}"><svg width="12" height="12" fill="#ffffff"
                                    shape-rendering="geometricPrecision" text-rendering="geometricPrecision"
                                    image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd"
                                    viewBox="0 0 322 511.21">
                                    <path fill-rule="nonzero"
                                  ...
                                  <th>Price <a href="{{Request::url().$queryStringConcat}}&order_by=price&sorting={{($appliedFilter['sorting']=='desc') ? 'asc' : 'desc'}}"><svg width="12" height="12" fill="#ffffff"
                                    shape-rendering="geometricPrecision" text-rendering="geometricPrecision"
                                    image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd"
                                    viewBox="0 0 322 511.21">
                                    <path fill-rule="nonzero"
                          ...
                          <tbody class="td-data-color">
                           @forelse($featureFlighTypeData as $key=>$data)
                            <tr>
                              <th class="list-checkbox">
                              ...
                              <td>
                                @if($data['getAirline'])
                                  @if($data['getAirline']['airlineCodeName'])
                                    @foreach($data['getAirline']['airlineCodeName'] as $airline)
                              ...
                              <td class="">
                                <a href="{{ route('feature-flight.show',$data['id']) }}" title="View">
                                @if($data['getFromAirport'])
                                    @foreach($data['getFromAirport']['airportName'] as $airport)
                              ...
                              <td>
                              @if($data['getToAirport'])
                                    @foreach($data['getToAirport']['airportName'] as $airport)
                                      {{$airport->airport_name}} <br>
                                    @endforeach
                                @endif
                              </td>
                              ...
                              <span>  
                                ...
                                <span>
                                  <a href="{{ route('feature-flight.edit',$data['id']) }}" title="Edit">
                                    <?xml version="1.0"?><svg fill="#198754" viewBox="0 0 24 24" width="20" height="20">
                                      <path
                                        d="M 19.171875 2 C 18.448125 2 17.724375 2.275625 17.171875 2.828125 L 16 4 L 20 8 L 21.171875 6.828125 C 22.275875 5.724125 22.275875 3.933125 21.171875 2.828125 C 20.619375 2.275625 19.895625 2 19.171875 2 z M 14.5 5.5 L 3 17 L 3 21 L 7 21 L 18.5 9.5 L 14.5 5.5 z" />
                                    </svg></a></span>
                                <span>
                                  <a data-url="{{route('feature-flight.delete',['feature_flight_id'=>$data['id']])}}" data-bs-toggle="modal" data-bs-target="#exampleModal" type="button" title="Delete"
                      ...
                      <nav class="pagination-grid" aria-label="Page  navigation example">
                        <ul class="pagination">
                        <?php 
                        if($featureFlighTypeData)
                        {
                          if($featureFlighTypeData->hasPages()) { ?>
                            {!!$featureFlighTypeData->appends(Request::except('page'))->render() !!}
                              <?php } 
                          }?>
                      </nav>
                      <!-- /.card-body -->
