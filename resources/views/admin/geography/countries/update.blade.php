    ...
    <div class="container-fluid">
        <div class="row mb-4 mt-2">
            <div class="col-sm-12 d-flex breadcrumb-style">
                <h1 class="m-0">@lang('country.editCountry')</h1>
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">@lang('country.edit')</li>
                </ol>
            </div><!-- /.col -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="card pb-4 pt-3 px-3 w-100">
                <form method="post" action="{{route('countries.update',$countryDetail['id'])}}" id="countryForm" class="form row mb-0 validate" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <input type="hidden" name="redirects_to" id="redirects_to" value="{{ URL::previous() }}">
                    <input type="hidden" name="country_id" id="country_id" value="{{$countryDetail['id']}}" />

                    <div class="brdr-btm row">
                        <div class="col-md-6">
                            <div class="form-item form-float-style">
                                <input type="text" id="country_name_en" name="country_names[0][country_name]" autocomplete="off" class="is-valid" required value="{{$countryDetail['countryCode'][0]['country_name']}}">
                                <input type="hidden" id="language_code_en" name="country_names[0][language_code]" autocomplete="off" class="is-valid" value="en">
                                <input type="hidden" id="country_i18ns_en_id" name="country_names[0][country_i18ns_id]" autocomplete="off" class="is-valid" value="{{$countryDetail['countryCode'][0]['id']}}">
                                <label for="name">@lang('country.countryNameEn') <span class="req-star">*</span></label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-item form-float-style">
                                <input type="text" id="country_name_ar" name="country_names[1][country_name]" autocomplete="off" class="is-valid" required value="{{$countryDetail['countryCode'][1]['country_name']}}">
                                <input type="hidden" id="language_code_ar" name="country_names[1][language_code]" autocomplete="off" class="is-valid" value="ar">
                                <input type="hidden" id="country_i18ns_ar_id" name="country_names[1][country_i18ns_id]" autocomplete="off" class="is-valid" value="{{$countryDetail['countryCode'][1]['id']}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-item form-float-style">
                                <input type="text" class="is-valid" id="iso_code" name="iso_code" autocomplete="off" required value="{{$countryDetail['iso_code']}}" readonly>
                        ...
                        <div class="col-md-6">
                            <div class="form-item form-float-style">
                                <input type="text" class="is-valid" id="isd_code" name="isd_code" class="workingCityAutocomplete1" autocomplete="off" value="{{$countryDetail['isd_code']}}">
                                <label for="city">@lang('country.isd_code') <span class="req-star">*</span></label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-item form-float-style">
                                <input type="text" id="max_mobile_number_length" name="max_mobile_number_length" class="is-valid" autocomplete="off" value="{{$countryDetail['max_mobile_number_length']}}">
                                ...
                                <div class="form-item form-float-style serach-rem mb-0">
                                    <div class="select top-space-rem after-drp form-float-style ">
                                        <select data-live-search="true" id="status" name="status" class="order-td-input selectpicker select-text height_drp is-valid">
                                            <option @if($countryDetail['status']=='active' ) selected="selected" @endif value="active" selected="">@lang('country.active')</option>
                                            <option @if($countryDetail['status']=='inactive' ) selected="selected" @endif value="inactive">@lang('country.inActive')</option>
                                        </select>
                    ...
                    <div class="cards-btn mt-3">
                        ...
                        <a href="{{ route('countries.index') }}" type="button" class="btn btn-danger form-btn-danger">Cancel</a>
                    </div>
                </form>
                ...
                "country_names[0][country_name]": {
                    ...
                    remote: {
                        ...
                        data: {
                            ...
                            "country_names[0][country_i18ns_id]": function() {
                                return $("#country_i18ns_en_id").val();
                            },
                            "_token": '{{ csrf_token() }}'
                        }
                    }
                ...
                "country_names[1][country_name]": {
                    ...
                    remote: {
                        ...
                        data: {
                            ...
                            "country_names[1][country_i18ns_id]": function() {
                                return $("#country_i18ns_ar_id").val();
                            },
                            "_token": '{{ csrf_token() }}'
                        }
                    }
