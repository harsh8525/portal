...
$(document).ready(function () {
    $('.form-float-style').find('.input-password').each(function (index, input) {
      var $input = $(input);
...
// A Validity State Polyfill Form Validations
...
if (!message) {
    ...
    var label;
    if (field.type === 'radio' || field.type === 'email' || field.type ==='checkbox' || field.type ==='text' || field.type ==='password' || field.type ==='number' || field.type ==='file' || field.type ==='textarea' || field.type ==='select') {
...
// Form Vlidation Complete


// Password Genrate
let pass = document.getElementById("genpass");
let btn = document.getElementById("genp");
