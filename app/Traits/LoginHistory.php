...
trait LoginHistory
{
    ...
    public static function createLoginHistory($requestData)
    {
        ...
        try {
            ...
            $browserDetail = self::getBrowserInfo();
            ...
            $userLoginHistory->device_os = $browserDetail['device_os'];
            ...
            $userLoginHistory->app_version =$browserDetail['browser_version'] ?? '';
            // echo "<pre>";print_r($userLoginHistory);die;
